...
def validate_metadata(
    *,
    ...
    device_id: str,
    wearing_state: str,
    armband_orientation: str = "unknown",
) -> RecordingMetadata:
    missing = [
        name
        for name, value in (
    ...
    return RecordingMetadata(
        ...
        armband_orientation=sanitize_token(normalize_armband_orientation(armband_orientation)),
    )
...
def build_relative_recording_path(
    ...
    *,
    ...
    stem = (
        ...
        f"__ao-{metadata.armband_orientation}"
...
def build_manifest_row(
    *,
    ...
    return {
        ...
        "armband_orientation": metadata.armband_orientation,
