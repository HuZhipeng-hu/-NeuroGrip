...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "e.g. TENSE_OPEN,V_SIGN,THUMB_UP,WRIST_CW. CONTINUE is implicit."
        ),
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Train-only sample budget per class (default: 0 disables budgeting). Validation/test splits are unchanged.",
    )
    parser.add_argument(
        "--budget_seed",
        type=int,
    ...
    parser.add_argument(
        ...
        default=None,
        help="Comma-separated old action keys used by incremental_from_checkpoint (CONTINUE is implicit).",
    )
    parser.add_argument(
