...
def create_actuator(config: HardwareConfig) -> ActuatorBase:
    ...
    return PCA9685Actuator(
        ...
        wrist_channel=config.actuator_wrist_channel,
        safe_profile_preset=config.safe_profile_preset,
        wrist_neutral_angle=config.servo_angle_wrist_neutral,
        wrist_cw_angle=config.servo_angle_wrist_cw,
    )
