...
def test_tense_open_matches_relax_pose():
    assert get_finger_angles(GestureType.TENSE_OPEN) == get_finger_angles(GestureType.RELAX)
...
if __name__ == "__main__":
    tests = [
        ...
        test_tense_open_matches_relax_pose,
    ]
