...
def reset_momentary_runtime_state(
    ...
    """Release momentary wrist actions immediately after actuation.

    Demo wrist actions are pulses, not latched hand poses. Keep the emitted
    decision for logging/actuation, then return the controller to CONTINUE so
    repeated wrist intents can trigger again.
    """
